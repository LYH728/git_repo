package com.fudan.ast.grpcpaperserver.constant;
...
public enum StatusCode {
    ...
    SUBMISSION_NOT_FOUND(404, "There is no Submission.proto found"),
    ...
    ONLY_ONE_SUBMISSION_IN_EACH_CONFERENCE(502, "For every conference, each candidate " +
            "can only have one Submission.proto"),
    ...
    INVALID_EMAIL_ADDRESS(508, "Please enter a valid email address");
